...
<form action="{{ route('signin.post') }}" method="POST" enctype="multipart/form-data">
    ...
    <a href="#" class="px-9 py-2 lg:h-[3.5rem] h-[2.5rem] text-xs lg:text-base w-full flex border border-[#555555] items-center justify-center mb-4 rounded-md hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-500">
